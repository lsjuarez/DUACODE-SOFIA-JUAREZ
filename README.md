...
- To try the 'uploadDuacoderPhoto' API go to Postman and import the next curl: curl --location 'localhost:APP_PORT/duacoder-handler/api/v1/uploadDuacoderPhoto' \
